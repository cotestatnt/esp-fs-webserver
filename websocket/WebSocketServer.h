...
class WebSocketServerCore : protected WebSocket {
  public:
    WebSocketServerCore(const String & origin = "", const String & protocol = "arduino");
    virtual ~WebSocketServerCore(void);
  ...
  protected:
     ...
     * socket negotiation is considered invalid and the upgrade to WebSocket request is denied / rejected
...
class WebSocketServer : public WebSocketServerCore {
  public:
    WebSocketServer(uint16_t port, const String & origin = "", const String & protocol = "arduino");
